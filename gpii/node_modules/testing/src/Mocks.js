...
// =============================
// Mock Process Reporter


/*
fluid.defaults("gpii.test.integration.mockProcessReporter", {
    gradeNames: ["gpii.processReporter", "gpii.contexts.test.integration"],
    invokers: {
    }
};
*/

// This function is referenced in the solutions registry entry
fluid.defaults("gpii.processReporter.find", {
    gradeNames: "fluid.function",
    argumentMap: {
        command: 0
                 // command naem of process to search for
    }
});

/**
 * Mock search for a process with the given cammand name. Always returns
 * true.
