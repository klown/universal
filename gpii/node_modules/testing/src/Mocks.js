...
fluid.defaults("gpii.test.integration.exec", {
    ...
    components: {
        processReporter: {
            type: "gpii.processReporter"
        },
        processes: {
            type: "gpii.test.integration.mockProcesses"
        }
    },
    invokers: {
        exec: {
...
//    debugger;
//    var y = 2;
    var isRunning = that.processReporter.handleIsRunning(processSpec);
    that.events.onExecExit.fire(isRunning, processSpec);
//    }
//    catch (error) {
//        debugger;
//        var x = 5;
...
fluid.defaults("gpii.test.integration.mockHolder", {
    ...
    listeners: {
        "onCreate": {
            funcName: "gpii.test.integration.mockHolder.created",
            args: ["{that}"]
        }
    }
});

gpii.test.integration.mockHolder.created = function (that) {
//    debugger;
    var z = 2 * 3;
    var anObj = { x: that, y: z };
    console.log("MOCKHOLDER created:  " + (anObj === null ? "null" : "non-null"));
};
...
//    debugger;
    ...
    console.log("GETPROCESSLIST called; returning '" + togo + "'");
    return togo;
};
