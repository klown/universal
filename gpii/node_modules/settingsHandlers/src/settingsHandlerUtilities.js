...
gpii.settingsHandlers.invokeGetHandler = function (resolvedName, payload) {
    if (resolvedName && resolvedName.indexOf("flexible") !== -1) {
        debugger;
    }
    console.log ("INVOKE GET HANDLER: '" + resolvedName + "', with payload: " + fluid.prettyPrintJSON(payload));
    var aResult = fluid.invokeGlobalFunction(resolvedName + ".get", [payload]);
    console.log ("INVOKE GET HANDLER: result is '" + fluid.prettyPrintJSON(aResult) + "'");
//    debugger;
    return gpii.toPromise(aResult);
